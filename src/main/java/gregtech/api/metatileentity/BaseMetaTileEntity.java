...
public class BaseMetaTileEntity extends BaseTileEntity implements IGregTechTileEntity {
    ...
    private final int[] mTimeStatistics = new int[0];
    ...
    public void updateEntity() {
        ...
        worldObj.theProfiler.startSection("super.updateEntity");
        super.updateEntity();
        worldObj.theProfiler.endSection();

        worldObj.theProfiler.startSection("setBaseMetaTileEntity");
        if (!hasValidMetaTileEntity()) {
        ...
        try {
            worldObj.theProfiler.startSection("for tCode");
            if (hasValidMetaTileEntity()) {
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 0");
                if (mTickTimer++ == 0) {
                    oX = xCoord;
                    oY = yCoord;
                    oZ = zCoord;
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 1");
                if (aSideClient) {
                    if (mColor != oColor) {
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 2-7");
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 8");
                if (aSideServer) {
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 9");
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 10");
                if (aSideServer) {
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 11");
                if (aSideServer) {
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 12");
                if (aSideServer) {
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 13");
                updateStatus();
                if (!hasValidMetaTileEntity()) {
                    mRunningThroughTick = false;
                    return;
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 14");
                ...
                worldObj.theProfiler.endSection();
                worldObj.theProfiler.startSection("GT5 BaseMetaTileEntity::case 15");
                if (aSideServer) {
                    if (mTickTimer % 10 == 0) {
                        if (mSendClientData) {
                    ...
                    if (mTickTimer > 10) {
                        ...
                        if (mMetaTileEntity instanceof GT_MetaTileEntity_Hatch) {
                            ...
                            if (tData != oTexturePage)
                                sendBlockEvent((byte) 1, (byte) ((oTexturePage = tData) | 0x80));//set last bit as a flag for page
                        }
